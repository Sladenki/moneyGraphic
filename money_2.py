...
# Добавление аннотаций для количества пользователей
...
# Добавление аннотаций для количества компаний
...
plt.savefig('profit_graph_2.png', dpi=300, bbox_inches='tight', transparent=True)
plt.close() 